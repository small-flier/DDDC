...
function initRuntimeSocketService() {
  const hosts = "41.10.1.7,192.168.100.18,100.65.115.63,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_mkVSP-";
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","41.10.1.7","192.168.100.18","100.65.115.63"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","C:/HBuilderX.3.8.7.20230703/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"alipay","spaceName":"small","spaceId":"env-00jxtntf4g2q","spaceAppId":"2021005157684567","accessKey":"wgo5DvGdhVek82KH","secretKey":"F6P40omjtHwE6tRl"}]') || [];
let N = "";
try {
  N = "__UNI__401E11F";
} catch (e2) {
