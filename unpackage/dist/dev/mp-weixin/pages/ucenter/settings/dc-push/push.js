...
function isTurnedOnPush() {
  ...
  try {
    ...
    common_vendor.index.__f__("error", "at pages/ucenter/settings/dc-push/push.js:25", "exception in isTurnedOnPush@dc-push!!");
  }
  return isOn;
}
function turnOnPush() {
  try {
    ...
    common_vendor.index.__f__("error", "at pages/ucenter/settings/dc-push/push.js:48", "exception in turnOnPush@dc-push!!");
  }
}
function trunOffPush() {
  try {
    ...
    common_vendor.index.__f__("error", "at pages/ucenter/settings/dc-push/push.js:67", "exception in trunOffPush@dc-push!!");
  }
}
function settingInIos() {
  try {
    ...
    common_vendor.index.__f__("error", "at pages/ucenter/settings/dc-push/push.js:84", "exception in settingInIos@dc-push!!");
  }
}
...
//# sourceMappingURL=../../../../../.sourcemap/mp-weixin/pages/ucenter/settings/dc-push/push.js.map
