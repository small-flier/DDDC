...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "c794a336-3-" + i0 + "-" + i1 + "," + ("c794a336-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            f: "c794a336-2-" + i0 + "-" + i1 + "," + ("c794a336-1-" + i0)
          };
        }),
        b: "c794a336-1-" + i0 + ",c794a336-0",
        c: "c794a336-4-" + i0 + ",c794a336-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "c794a336-0"),
